    ...
    posts: [
      {
        public_id: "1",
        title:
          "Cara Install Odoo di Ubuntu 22.04 Until 2 line example is possible",
              ...
              <div className="group relative mb-2 overflow-hidden rounded-xl bg-gray-900 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                <Link to="/blog/my-first-blog">
                  <img
                    ...
                    alt={post.title}
                    className="w-full object-cover transition-all duration-700 ease-out group-hover:scale-110 group-hover:opacity-75 group-hover:saturate-150"
                  />
